import { calcBeverageCost, type StockItem } from "@/context/BonifaceContext";
...
export function summarizeBeverageCost(stockItems: StockItem[]): BeverageCostSummary {
  ...
  return {
    ...
    itemsWithPricing: items.length,
    itemsMissingPricing: stockItems.length - items.length,
    items,
  };
}
